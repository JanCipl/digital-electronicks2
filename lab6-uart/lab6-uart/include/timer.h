...
#define TIM1_OVF_4S  TCCR1B &= ~(1<<CS11); TCCR1B |= (1<<CS12) | (1<<CS10);
...
// /*CAS ZDE NEJNI SPRAVNY*/
// #define TIM0_OVF_16MS  TCCR0B &= ~(1<<CS01); TCCR0B |= (1<<CS02) | (1<<CS00);
// #define TIM1_OVF_4MS   TCCR0B &= ~((1<<CS02) | (1<<CS01)); TCCR0B |= (1<<CS00);
// /** @brief Set overflow 33ms, prescaler 010 --> 8 */
// #define TIM1_OVF_33MS  TCCR0B &= ~((1<<CS02) | (1<<CS00)); TCCR0B |= (1<<CS01);
// /** @brief Set overflow 262ms, prescaler 011 --> 64 */
// #define TIM1_OVF_262MS TCCR0B &= ~(1<<CS02); TCCR0B |= (1<<CS01) | (1<<CS00);
// /** @brief Set overflow 1s, prescaler 100 --> 256 */
// #define TIM1_OVF_1SEC  TCCR0B &= ~((1<<CS01) | (1<<CS00)); TCCR1B |= (1<<CS02);
